...
ax1.plot(x_everhart,y_everhart, label = "Everhart, Ωc∆t = 0.63",linewidth=0.5,color="mediumblue")
ax1.plot(x_boris_001,y_boris_001, label = "Boris, Ωc∆t = 0.001",linewidth=0.5,linestyle="dashed",color="indianred")
ax1.plot(x_boris_1,y_boris_1, label = "Boris, Ωc∆t = 0.1",linewidth=0.5,color="orange")
...
axins.plot(x_everhart,y_everhart, label = "Everhart, Ωc∆t = 0.63",linewidth=0.5,color="mediumblue")
axins.plot(x_boris_001,y_boris_001, label = "Boris, Ωc∆t = 0.001",linewidth=0.5,linestyle="dashed",color="indianred")
