...
ax1.plot(time_everhart,y_everhart, label = "Everhart, Ωc∆t = 0.63",linewidth=0.75,color="mediumblue")
ax1.plot(time_boris_1,y_boris_1, label = "Boris, Ωc∆t = 0.1",linewidth=0.75,color="orange")
ax1.plot(time_boris_001,y_boris_001, label = "Boris, Ωc∆t = 0.001",linewidth=0.75,color="indianred",linestyle="dashed")
...
axins.plot(time_everhart,y_everhart, label = "Everhart, Ωc∆t = 0.63",linewidth=0.75,color="mediumblue")
axins.plot(time_boris_1,y_boris_1, label = "Boris, Ωc∆t = 0.1",linewidth=0.75,color="orange")
axins.plot(time_boris_001,y_boris_001, label = "Boris, Ωc∆t = 0.001",linewidth=0.75,color="indianred",linestyle="dashed")
...
plt.savefig('trajectory_y.eps', format='eps')
