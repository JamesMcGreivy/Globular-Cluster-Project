...
pos_boris_001 = 'boris 0.001/pos_data.csv'
vel_boris_001 = 'boris 0.001/vel_data.csv'

positions = []
velocities = []
times = []

with open(pos_boris_001) as csvfile:
...
with open(vel_boris_001) as csvfile:
...
#Get all of the data for boris 0.1
pos_boris_1 = 'boris 0.1/pos_data.csv'
vel_boris_1 = 'boris 0.1/vel_data.csv'

positions = []
velocities = []
times = []

with open(pos_boris_1) as csvfile:
...
with open(vel_boris_1) as csvfile:
...
ax.plot(everhart_data.times, get_energy_error(everhart_data), label = "Everhart, Ωc∆t = 0.63",linewidth=0.75, color="mediumblue")
ax.plot(boris_data_001.times, get_energy_error(boris_data_001), label = "Boris, Ωc∆t = 0.001",linewidth=0.75, color="indianred")
ax.plot(boris_data_1.times, get_energy_error(boris_data_1), label = "Boris, Ωc∆t = 0.1",linewidth=0.75, color="orange")
