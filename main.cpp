...
int main()
{
	...
	std::vector<ODE_Integrator::ArrayPair> data = ODE_Integrator::Integrate(gravity, 0, t_final, positions, velocities, dt, t_eval);
	...
	{	
		...
		position_data << dt*i << std::endl;
		velocity_data << dt*i << std::endl;
